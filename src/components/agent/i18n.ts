...
const STRINGS: Record<Locale, StringTable> = {
  pt: {
    ...
    'draft.superseded': 'Substituído por rascunho mais recente',

    'setup.title': 'Antes de gerar, me conta como você quer:',
    'setup.duration': 'Duração',
    'setup.duration.original': 'Igual ao original',
    'setup.tone': 'Tom',
    'setup.tone.original': 'Vibe original',
    'setup.tone.casual': 'Casual',
    'setup.tone.direct': 'Direto',
    'setup.tone.educational': 'Educativo',
    'setup.focus': 'Foco',
    'setup.focus.adapt': 'Adaptar pro meu nicho',
    'setup.focus.summarize': 'Resumir',
    'setup.focus.detail': 'Detalhar',
    'setup.submit': 'Gerar roteiro',
    'setup.skip': 'Pular',
    'setup.cancel': 'Cancelar',
    'setup.submitted': 'Pronto, gerando…',
    'setup.skipped': 'Pulado — usando padrões',
    'setup.cancelled': 'Cancelado',
    ...
    'tool.setBlockPhoto.doing': 'Trocando a foto do bloco…',
    ...
    'tool.setBlockPhoto.done': 'Foto do bloco trocada',
  ...
  en: {
    ...
    'setup.title': 'Before I generate, how do you want it:',
    'setup.duration': 'Duration',
    'setup.duration.original': 'Same as original',
    'setup.tone': 'Tone',
    'setup.tone.original': 'Original vibe',
    'setup.tone.casual': 'Casual',
    'setup.tone.direct': 'Direct',
    'setup.tone.educational': 'Educational',
    'setup.focus': 'Focus',
    'setup.focus.adapt': 'Adapt to my niche',
    'setup.focus.summarize': 'Summarize',
    'setup.focus.detail': 'Detail',
    'setup.submit': 'Generate script',
    'setup.skip': 'Skip',
    'setup.cancel': 'Cancel',
    'setup.submitted': 'Done, generating…',
    'setup.skipped': 'Skipped — using defaults',
    ...
    'tool.setBlockPhoto.doing': 'Swapping block photo…',
    ...
    'tool.setBlockPhoto.done': 'Block photo swapped',
