          ...
          {readyToRender && (
            <>
              ...
              <div className="px-6 py-4 flex gap-2 border-t border-white/5 bg-black/30">
                ...
                <button onClick={startRender} className="flex-1 py-2.5 rounded-lg bg-gradient-to-b from-violet-500 to-violet-600 hover:from-violet-400 hover:to-violet-500 text-xs font-semibold text-white shadow-[0_0_20px_rgba(10,132,255,0.5)]">
                  Renderizar agora
                </button>
              </div>
            </>
      ...
      <div className="fixed inset-0 bg-black/85 backdrop-blur-xl flex items-center justify-center z-[80] p-6" onClick={onClose}>
        <div className="bg-[#141416] border border-white/10 rounded-2xl shadow-2xl max-w-md w-full overflow-hidden" onClick={e => e.stopPropagation()}>
          ...
          <div className="px-6 py-4 flex gap-2 border-t border-white/5">
            ...
            <button onClick={downloadResult} className="flex-1 py-2.5 rounded-lg bg-gradient-to-b from-violet-500 to-violet-600 hover:from-violet-400 hover:to-violet-500 text-xs font-semibold text-white shadow-[0_0_20px_rgba(10,132,255,0.5)] flex items-center justify-center gap-2">
