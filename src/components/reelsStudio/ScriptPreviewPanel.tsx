      ...
      <div className="px-6 pt-5 pb-4 border-b border-white/5 shrink-0">
        <div className="flex items-start justify-between gap-3">
          <div className="flex-1 min-w-0">
            <div className="text-[10px] uppercase tracking-[0.18em] text-blue-300 font-semibold mb-1">
              ✨ Roteiro proposto
            </div>
            ...
            <div className="flex items-center gap-2 flex-wrap text-[10.5px] text-zinc-400">
              ...
              {detectedHeader.framework && (
                <span className="px-2 py-0.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-200">
                  {detectedHeader.framework}
                </span>
              )}
      ...
      <div className="flex-1 min-h-0 overflow-y-auto px-6 pb-3 space-y-2">
            ...
            >
              <div className="flex items-center gap-2 mb-1.5">
                ...
                <div className="ml-auto flex items-center gap-1">
                  <button
                    ...
                    disabled={anyBusy}
                    className="p-1 rounded text-zinc-500 hover:text-blue-300 hover:bg-blue-500/10 transition-colors disabled:opacity-40"
              ...
              {busyHere && (
                <div className="absolute inset-0 flex items-center justify-center bg-black/30 rounded-lg">
                  <div className="text-[11px] text-blue-300 animate-pulse">Regenerando bloco…</div>
                </div>
              )}
              ...
              {showRegen && !busyHere && (
                <div className="mt-2 pt-2 border-t border-white/5 space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full text-[11px] bg-black/40 border border-white/10 rounded-md px-2 py-1.5 text-zinc-200 placeholder:text-zinc-600 outline-none focus:border-blue-400/50"
                  />
                  <div className="flex items-center gap-1 flex-wrap">
                    {REGEN_PRESETS.map(p => (
                      <button
                        ...
                        className="px-2 py-0.5 rounded-full bg-white/5 hover:bg-blue-500/15 border border-white/10 hover:border-blue-400/30 text-[10px] text-zinc-300 hover:text-blue-100"
                      >
                        + {p.label}
                      </button>
                    ))}
                  ...
                  <div className="flex items-center gap-1.5 justify-end">
                    ...
                    <button
                      ...
                      className="px-2.5 py-1 rounded bg-blue-500/20 hover:bg-blue-500/30 border border-blue-500/40 text-[10.5px] font-semibold text-blue-100"
                    >
                      Regenerar →
                    </button>
                  </div>
        ...
        {!showAddBlockForm ? (
          <button
            ...
            disabled={anyBusy}
            className="w-full px-3 py-2 rounded-lg border border-dashed border-white/10 hover:border-blue-400/40 text-[11px] text-zinc-500 hover:text-blue-200 transition-colors disabled:opacity-40"
          >
            + Adicionar bloco com IA
          </button>
        ) : (
          <div className="px-3 py-2.5 rounded-lg border border-blue-400/30 bg-blue-500/5 space-y-2">
            <div className="text-[10px] uppercase tracking-wider text-blue-300 font-semibold">Novo bloco com IA</div>
            ...
            <div className="flex items-center gap-1.5 justify-end">
              ...
              <button
                ...
                disabled={isBusyAdd}
                className="px-2.5 py-1 rounded bg-blue-500/20 hover:bg-blue-500/30 border border-blue-500/40 text-[10.5px] font-semibold text-blue-100 disabled:opacity-50"
              >
      ...
      <div className="px-6 py-4 border-t border-white/5 bg-black/30 shrink-0 space-y-2">
        {showRegenerateAllForm && !isBusyAll && (
          <div className="px-3 py-2.5 rounded-lg bg-black/40 border border-white/10 space-y-2">
            ...
            <textarea
              ...
              className="w-full text-[11px] bg-black/30 border border-white/10 rounded-md px-2 py-1.5 text-zinc-200 placeholder:text-zinc-600 outline-none focus:border-blue-400/50"
            />
            <div className="flex items-center gap-1 flex-wrap">
              {REGEN_PRESETS.map(p => (
                <button
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-4 py-2 rounded-lg bg-gradient-to-b from-blue-500 to-blue-600 hover:from-blue-400 hover:to-blue-500 text-[12px] font-semibold text-white shadow-[0_0_20px_rgba(10,132,255,0.4)] transition-all disabled:opacity-40 disabled:cursor-not-allowed"
          >
            Usar este roteiro →
          </button>
        </div>
