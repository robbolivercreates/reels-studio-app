      ...
      <div className="min-h-screen bg-[#0a0a0b] flex items-center justify-center p-6">
        <div className="bg-[#141416] border border-white/10 rounded-3xl shadow-[0_30px_80px_rgba(0,0,0,0.8)] p-10 max-w-md w-full text-center">
          ...
          <button
            ...
            className="w-full py-3.5 bg-gradient-to-b from-blue-500 to-blue-600 hover:from-blue-400 hover:to-blue-500 text-white font-semibold rounded-xl transition-colors shadow-[0_0_20px_rgba(10,132,255,0.4)]"
          >
            Configurar chaves
          </button>
        </div>
